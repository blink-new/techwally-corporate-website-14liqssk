        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-heading font-bold">Techwally</span>
            </div>
            <p className="text-slate-300 text-sm leading-relaxed">
              Leading provider of enterprise IT solutions, delivering innovative technology services that drive business growth and operational excellence.
            </p>
          ...
          {/* Solutions */}
          <div className="space-y-4">
            <h3 className="text-lg font-heading font-semibold">Solutions</h3>
            <ul className="space-y-2 text-sm">
