      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-2xl lg:text-3xl font-heading font-bold text-slate-900 mb-2">
                        {study.title}
                      </h3>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {study.results.map((result, resultIndex) => (
                        <div key={resultIndex} className="text-center p-4 bg-slate-50 rounded-lg">
                          <div className="text-2xl font-heading font-bold text-primary">{result.metric}</div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-sm border border-slate-200">
            <h3 className="text-2xl lg:text-3xl font-heading font-bold text-slate-900 mb-4">
