        ...
        <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {message.suggestions.map((suggestion, index) => (
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="text-xs h-8 rounded-full border-blue-200 text-blue-600 hover:bg-blue-50"
          ...
          {isTyping && (
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center bg-white text-blue-600 border-2 border-blue-100 shadow-sm">
                <Bot className="h-5 w-5" />
              </div>
